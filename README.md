...
Kubernetes controller that provisions a team namespace, ResourceQuota, and admin RBAC from a single custom resource. Demonstrates CRD, reconcile loop, owner references, and status subresource.
...
Give it a list of company names, it probes six public ATS APIs and returns the exact endpoint to pull their open roles. Feeds the n8n Job Feed Builder.
...
Automated AWS cost monitoring with n8n on EKS. Detects spend anomalies, triggers alerts, and routes to the right team. No manual dashboard checking.
...
AI-powered CV screening and candidate pipeline automation with working n8n JSON workflow.
...
### ☸️ [k8s-cost-optimizer](https://github.com/ramalakshmi0505/k8s-cost-optimizer)
Kubernetes cost optimization tooling. Identifies oversized workloads, unused resources, and right-sizing opportunities across namespaces.
